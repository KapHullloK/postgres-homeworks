...
select customers.company_name, concat(employees.first_name, ' ', employees.last_name) as employees_name
from orders
...
from products
where products.product_id in (select order_details.product_id
                              from order_details
